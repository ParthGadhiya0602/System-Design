...
> **F, L0, L1, and L2 are** `done` (F + L0 = 25 foundation lessons; L1 = all 17 networking lessons; L2 = all 13 storage/relational-DB lessons, finishing with OLTP vs OLAP). **L3 is in progress** (2 of 8: caching layers and strategies, eviction policies done). Next in order:
>
> 1. **L3. Caching and Data Access** - continue with Redis vs Memcached.
