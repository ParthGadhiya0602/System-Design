...
> **F and L0 are** `done` (all 25 foundation lessons written). **L1 in progress** (15 of 17 done). Next in order:
>
> 1. **L1. Networking** - continue in order. Next topic: Anycast / BGP basics.
