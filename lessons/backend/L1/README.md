...
**In progress** -- topic 1 of 17 is written. Work through them in order; each is a short, self-contained read (~5-8 min).
...
| 02 | IP Addressing and Subnets | How hosts are named and grouped, and how a router decides "local or route it." | ⚪ |
| 03 | DNS Deep | Turning names into IPs -- the hierarchy, caching, and record types behind every lookup. | ⚪ |
