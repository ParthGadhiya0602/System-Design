...
**In progress** -- 1 of 8 topics written. Work through them in order; each is a short, self-contained read (~5-8 min).
...
| 02 | Eviction policies (LRU, LFU, TTL) | When the cache is full, what gets thrown out first -- and why the "right" policy depends on the access pattern. | ⚪ |
